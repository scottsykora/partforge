...
**Fix applied:** Task 3 Step 3's dead `controlDescriptors` generator is a plan defect, not a teaching aid — an implementer reading out of order could paste it. Removing it from the code block and dropping the note.
