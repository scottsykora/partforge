...
// The pinch classes the probe-based resolver could not close — the reason this rewrite
// exists. Under per-piece probing, both pieces departing a pinch vertex probed
// wLeft=0/wRight=-1, neither straddled the positive rule, and the boundary dead-ended;
...
describe.skip("pinch classes the probe design could not close", () => {
  ...
  // chamfer 45.20274. Plate per the ledger: 32x9, notches x 1.869-5.132 depth 7.459
  // (floor y = 1.541) and x 8.404-9.429 depth 2.493 (floor y = 6.507).
